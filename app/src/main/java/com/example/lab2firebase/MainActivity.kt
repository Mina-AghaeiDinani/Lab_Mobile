...
import com.example.lab2firebase.helper.FirebaseHelper
import com.example.lab2firebase.helper.GoogleMapHelper
import com.example.lab2firebase.helper.MarkerAnimationHelper
import com.example.lab2firebase.helper.UiHelper
...
import com.example.lab2firebase.helper.*
import com.example.lab2firebase.interfaces.IPositiveNegativeListener
import com.example.lab2firebase.interfaces.LatLngInterpolator
import com.example.lab2firebase.model.Driver
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //press on button end registration
        val btnEndRegistration = findViewById<Button>(R.id.btnEndRegistration)
        btnEndRegistration.setOnClickListener {
            val intent = Intent(this@MainActivity, LoginActivity::class.java)
            Toast.makeText(this@MainActivity, "Registration has been done...", Toast.LENGTH_LONG).show()
